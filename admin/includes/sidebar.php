            ...
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    ...
                    <div id="submenu-2" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="booked_tickets.php">Booked
                                    Tickets</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="account.html">#</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-3" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            ...
                            <li class="submenu-item"><a class="submenu-link" href="add_plane.php">Add Plane Details</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-6" class="collapse submenu submenu-6" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="#">Administrators</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="#">Users</a></li>
                        </ul>
                    </div>
                </li>
                <!--//nav-item-->
