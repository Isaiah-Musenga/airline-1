			...
			<div class="container-xl">
				<div class="position-relative mb-3">
					<div class="row g-3 justify-content-center">
						<div class="col-auto">
							<h1 class="app-page-title mb-0 text-uppercase">Completed Flights</h1>
						</div>
					</div>
				</div>
				<hr class="mb-4">
				...
				<?php
					...
					if (isset($_GET['msgs']) && $_GET['msgs'] == 'success') {
                        echo "
                        <div class='alert alert-success alert-dismissible fade show text-center' role='alert'>
                            <strong style='color: green'>The Flight has been Added successfully.</strong>
                            <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                        </div>";
                    } 
				?>
									...
									<table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												...
												<th class="cell">Plane No.</th>
												<th class="cell">From City</th>
												<th class="cell">To City</th>
												<th class="cell">Journey Date</th>
