				...
				<div class="col-12 col-md-12">
					<div class="app-card app-card-settings shadow-sm p-4">
						<div class="app-card-body">
							<form class="settings-form" action="ticket_details_handler.php" method="post">
								<div class="row mb-3">
									<div class="col">
									...
									<label for="" class="form-label">Passenger Age</label>
										<input type="text" class="form-control" placeholder="Passeger Age" aria-label="Last name" name="age" required />
									</div>
								</div>
								<div class="row mb-3">
									<div class="col">
