...
<html>
	...
	<nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark">
		...
		<h2 class="text-center mt-4 mb-4">AVAILABLE FLIGHTS</h2>
		<div class="container">
				...
				if(empty($data_missing))
				{
					...
					if($class=="economy")
					{
						...
						else
						{
							...
							echo "<tr>
							<th class='table-dark'>Flight No.</th>
							<th class='table-dark'>Origin</th>
							<th class='table-dark'>Destination</th>
							<th class='table-dark'>Departure Date</th>
							<th class='table-dark'>Departure Time</th>
							<th class='table-dark'>Arrival Date</th>
							<th class='table-dark'>Arrival Time</th>
							<th class='table-dark'>Price(Economy)</th>
							<th class='table-dark'>Select</th>
							</tr>";
